...
# 测试环境配置
# docker的镜像发布地址
DOCKER_PERO_TEST=crpi-fj5aof5qiib3zd9p.cn-beijing.personal.cr.aliyuncs.com/easy-chat-goco/${SERVER_NAME}-${SERVER_TYPE}-dev
# 测试版本
...
tag-test:
	...
	docker tag ${APP_NAME_TEST} ${DOCKER_PERO_TEST}:${VERSION_TEST}

publish-test:
	@echo 'publish ${VERSION_TEST} to ${DOCKER_PERO_TEST}'
	docker push ${DOCKER_PERO_TEST}:${VERSION_TEST}
